            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="<?php echo base_url(); ?>modif/portfolio">Portfolio</a></li>
                        <li><a href="<?php echo base_url(); ?>modif/Daftarlaporan">Daftar laporan</a></li>
                        <li><a href="<?php echo base_url(); ?>modif/lapor">Lapor</a></li>
                        <li><a href="<?php echo base_url(); ?>modif/login">login</a></li>
                        <li><a href="<?php echo base_url(); ?>registrasi.html">registrasi</a></li>
                    </ul>
                </div>
            </div>
        </div>
			...
			<div class="col-lg-12">
				...
				<div class="row">
					...
					<ul id="thumbs" class="portfolio">
						...
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Portfolio name" href="<?php echo base_url(); ?>assets/img/works/5.png">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb"><h5>Project</h5> <p>Sed ut perspiciaatis unde omnis</p> <i class="icon-info-blocks fa fa-search"></i></span>
						</a>
						<!-- Thumb Image and Description -->
						<img src="<?php echo base_url(); ?>assets/img/works/5.png" alt="">
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs col-lg-3 photography" data-id="id-5" data-type="icon">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Portfolio name" href="<?php echo base_url(); ?>assets/img/works/6.png">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb"><h5>Project</h5> <p>Sed ut perspiciaatis unde omnis</p> <i class="icon-info-blocks fa fa-search"></i></span>
						</a>
						<!-- Thumb Image and Description -->
						<img src="<?php echo base_url(); ?>assets/img/works/6.png" alt="">
						</li>
						<!-- End Item Project -->
						<li class="item-thumbs col-lg-3 design" data-id="id-0" data-type="web">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Portfolio name" href="<?php echo base_url(); ?>assets/img/works/7.png">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb"><h5>Project</h5> <p>Sed ut perspiciaatis unde omnis</p> <i class="icon-info-blocks fa fa-search"></i></span>
						</a>
						<!-- Thumb Image and Description -->
						<img src="<?php echo base_url(); ?>assets/img/works/7.png" alt="">
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs col-lg-3 design" data-id="id-0" data-type="graphic">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="Portfolio name" href="<?php echo base_url(); ?>assets/img/works/8.png">
						<span class="overlay-img"></span>
						<span class="overlay-img-thumb"><h5>Project</h5> <p>Sed ut perspiciaatis unde omnis</p> <i class="icon-info-blocks fa fa-search"></i></span>
						</a>
						<!-- Thumb Image and Description -->
						<img src="<?php echo base_url(); ?>assets/img/works/8.png" alt="">
						</li>
						<!-- End Item Project -->
					</ul>
					</section>
